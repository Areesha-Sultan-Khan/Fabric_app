...
class LuxuryCollection extends StatefulWidget {
  @override
  _LuxuryCollectionState createState() => _LuxuryCollectionState();
}

class _LuxuryCollectionState extends State<LuxuryCollection> {
  final _service = ProductService();
  Future<List<Product>> product;

  void initState() {
    super.initState();
    product = _service.getProductsByCategory(9);
  }
